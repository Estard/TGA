...
namespace tga
{
    namespace /*private*/
    {
        ...
        vk::Extent2D chooseSwapExtent(vk::SurfaceKHR surface, const WindowInfo &windowInfo, vk::PhysicalDevice &pDevice)
        {
            ...
            return {
                std::clamp(windowInfo.width, capabilities.minImageExtent.width, capabilities.maxImageExtent.width),
    ...
    Window VulkanWSI::createWindow(const WindowInfo &windowInfo, vk::Instance &instance, vk::PhysicalDevice &pDevice,
                                   vk::Device &device, uint32_t queueFamiliy)
    {
        ...
        Window_vkData window_tv{surface,
                            swapchain,
                            extent,
                            surfaceFormat.format,
                            images,
    ...
    Window_vkData &VulkanWSI::getWindow(Window window) { return windows[window]; }
