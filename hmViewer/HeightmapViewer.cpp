...
void HeightmapViewer::setHeightmap(float* data, uint32_t imageWidth, uint32_t imageHeight, float terrainWidth = 1, float terrainDepth = 1, float terrainHeight = 1)
{
    ...
    heightmapInfo = {imageWidth,imageHeight,tga::Format::r32_sfloat,(uint8_t*)data,
        imageWidth*imageHeight*sizeof(float), tga::SamplerMode::linear,tga::RepeatMode::clampEdge};
...
void HeightmapViewer::createRescources()
{
    ...
    {tga::CompareOperation::less,false,tga::BlendFactor::srcAlpha,tga::BlendFactor::oneMinusSrcAlpha,
        tga::FrontFace::clockwise,tga::CullMode::back,tga::PolygonMode::solid},
        terrainInputLayout});
    ...
    {tga::CompareOperation::ignore,false,tga::BlendFactor::srcAlpha,tga::BlendFactor::oneMinusSrcAlpha,
        tga::FrontFace::counterclockwise,tga::CullMode::front,tga::PolygonMode::solid},
        terrainInputLayout});
